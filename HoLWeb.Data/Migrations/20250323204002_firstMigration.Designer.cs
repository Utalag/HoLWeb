...
namespace HoLWeb.DataLayer.Migrations
{
    ...
    [Migration("20250323204002_firstMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApplicationUserWorld", b =>
                {
                    b.Property<Guid>("PlayersInWorldId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<int>("WorldPlayersId")
                        .HasColumnType("int");

                    b.HasKey("PlayersInWorldId", "WorldPlayersId");

                    b.HasIndex("WorldPlayersId");

                    b.ToTable("Worlds_Players", (string)null);
                });

            modelBuilder.Entity("ApplicationUserWorld1", b =>
                {
                    b.Property<Guid>("GameMastersInWorldId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<int>("WorldGmsId")
                        .HasColumnType("int");

                    b.HasKey("GameMastersInWorldId", "WorldGmsId");

                    b.HasIndex("WorldGmsId");

                    b.ToTable("Worlds_GameMasters", (string)null);
                });
            ...
            modelBuilder.Entity("ApplicationUserWorld", b =>
                {
                    b.HasOne("HoLWeb.DataLayer.Models.IdentityModels.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("PlayersInWorldId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HoLWeb.DataLayer.Models.World", null)
                        .WithMany()
                        .HasForeignKey("WorldPlayersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("ApplicationUserWorld1", b =>
                {
                    b.HasOne("HoLWeb.DataLayer.Models.IdentityModels.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("GameMastersInWorldId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HoLWeb.DataLayer.Models.World", null)
                        .WithMany()
                        .HasForeignKey("WorldGmsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("HoLWeb.DataLayer.Models.Narrative", b =>
                {
                    ...
                    b.HasOne("HoLWeb.DataLayer.Models.ThumbModels.ThumbImgNarrative", "ThumbnailImage")
                        .WithOne("Narrative")
                        .HasForeignKey("HoLWeb.DataLayer.Models.Narrative", "ThumbnailImageId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("FK_Narrative_ImgThumb");
            ...
            modelBuilder.Entity("HoLWeb.DataLayer.Models.World", b =>
                {
                    ...
                    b.HasOne("HoLWeb.DataLayer.Models.ThumbModels.ThumbImgWorld", "ThumbnailImage")
                        .WithOne("World")
                        .HasForeignKey("HoLWeb.DataLayer.Models.World", "ThumbnailImageId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("FK_World_ImgThumb");
            ...
            modelBuilder.Entity("HoLWeb.DataLayer.Models.ThumbModels.ThumbImgCharacter", b =>
                {
                    b.HasOne("HoLWeb.DataLayer.Models.Character", "Character")
                        ...
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("FK_Character_ImgThumb");
            ...
            modelBuilder.Entity("HoLWeb.DataLayer.Models.ThumbModels.ThumbImgRace", b =>
                {
                    b.HasOne("HoLWeb.DataLayer.Models.Race", "Race")
                        ...
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("FK_Race_ImgThumb");
