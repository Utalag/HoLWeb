...
namespace HoLWeb.DataLayer.Migrations
{
    ...
    public partial class firstMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "Narratives_Players",
                columns: table => new
                {
                    NarrativesAsPlayersId = table.Column<int>(type: "int", nullable: false),
                    PlayersId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Narratives_Players", x => new { x.NarrativesAsPlayersId, x.PlayersId });
                    table.ForeignKey(
                        name: "FK_Narratives_Players_AspNetUsers_PlayersId",
                        column: x => x.PlayersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Narratives_Players_Naratives_NarrativesAsPlayersId",
                        column: x => x.NarrativesAsPlayersId,
                        principalTable: "Naratives",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.InsertData(
                table: "Worlds",
                columns: new[] { "Id", "AmountOfMagicInTheWorld", "FounderId", "ThumbnailImageId", "WorldDescription", "WorldName" },
                values: new object[,]
                {
                    { 1, 100, null, null, "Svět plný magie a kouzel, kde se můžete setkat s draky, elfy, trpaslíky a dalšími bytostmi.", "Fantasy svět" },
                    { 2, 25, null, null, "Svět, který prošel apokalypsou a kde se lidstvo snaží přežít v nepřátelském prostředí.", "Postapo" },
                    { 3, 0, null, null, "Svět, který známe, kde neexistuje magie a kouzla.", "Reálný svět" }
                });

            migrationBuilder.InsertData(
                table: "Naratives",
                columns: new[] { "Id", "Era", "GameMasterId", "NarrativeDescription", "NarrativeName", "ThumbnailImageId", "WorldId", "Year" },
                values: new object[,]
                {
                    { 1, "Císaře C-Chou", null, "Příběh ve vzdálené číně", "Čína", null, 1, 679 },
                    { 2, "III", null, "Boje v Persii", "Řecko", null, 1, 679 },
                    { 3, "XXI", null, "podle Pc hry", "Warhammer", null, 2, 3754 }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Narratives_Players_PlayersId",
                table: "Narratives_Players",
                column: "PlayersId");
